...
1. Fork `the repository <https://github.com/augmentedfabricationlab/timber_clay_hybrid>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/timber_clay_hybrid/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/timber_clay_hybrid/issues>`_. If you are proposing a feature:
