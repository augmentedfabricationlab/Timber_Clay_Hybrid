...
class Ceilingsystem:
    ...
    def __grid_creation(self):
        ...
        target = primary_graph_centre_minimum_x
            ...
            if layer == 0 or layer == self.layer_no - 1:
                ...
                if advanced and self.primary_outside_support_length > 0:
                    for i in range(len(self.ceiling_grids[0][1])):
                        print((self.timberboards[layer][i + 1].grid_position - self.timberboards[layer][i].grid_position) / 2 -
                            self.primary_board_width_outside)
                    ...
                    if advanced and self.primary_outside_support_length > 0:
                        for i in range(1, len(self.ceiling_grids[0][0]), 2):
                            ...
                            if (self.timberboards[layer][i//2 + 1].grid_position - self.timberboards[layer][i//2].grid_position >
                                ...
                                global_counter += 2
                                layer_counter += 1
                                print("2 boards inside")

                            else:
                                print("no board inside")
...
primary_falloff = 150.0
primary_dedensification = 5.0
