        ...
        for layer in range(self.layer_no):
            ...
            if layer % 2 == 0:
                if self.prim_vert_sup:
                    element_data_creator(self.primary_board_outside_dimensions, layer, global_counter, layer_counter,
                                         z_value, self.primary_direction, self.primary_direction,
            ...
            # secondary span
                ...
                if self.sec_vert_sup:
                    element_data_creator(self.secondary_board_dimensions, layer, global_counter, layer_counter,
                                         z_value, self.secondary_direction, self.primary_direction,
                                         self.primary_length/2, True, True)
                    global_counter += 1
                    layer_counter += 1
                    element_data_creator(self.secondary_board_dimensions, layer, global_counter, layer_counter,
                                         z_value, self.secondary_direction, self.primary_direction,
