...
class Ceilingsystem:
    def __init__(self, no_layers, min_gap, len_prim, len_sec, omni, prim_wid_out, prim_hi_out, prim_wid_in, prim_hi_in,
                 sec_wi, sec_hi, prim_intv, prim_fal, prim_dedens, sec_intv, sec_intv_dev, orgn_fram, skip, fac):
    ...
    def __grid_creation(self):
        ...
        b = (self.experiment_factor * d) / g - s
        a = (s - b) / (self.experiment_factor * g)
...
primary_interval = 16.0
primary_falloff = 140.0
...
myCeiling = Ceilingsystem(layer_no, gap_min, primary_length, secondary_length, omnidirectional,
                          ...
                          secondary_interval, secondary_interval_development, origin_frame, skip_centrals, 2.0)
