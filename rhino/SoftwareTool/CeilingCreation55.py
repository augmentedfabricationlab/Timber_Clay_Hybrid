...
layer_no = 5
gap_min = 4.0
primary_length = 2000.0
secondary_length = 300.0
omnidirectional = True
primary_board_width_outside = 8.0
primary_board_height_outside = 4.0
primary_board_width_inside = 8.0
...
myFloorslab.weight_calculator(5.0, 460, 1700, 2)
