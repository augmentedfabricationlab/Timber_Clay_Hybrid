        ...
        for layer in range(self.layer_no):
            ...
            if layer == 0 or (layer == self.layer_no - 1 and layer % 2 == 0):
                ...
                if advanced and self.primary_outside_support_length > 0:
                    for i in range(global_counter-1, global_counter - last_layer_pos, -1):
                        ...
                        if (self.network.node[i]["element"].grid_position - self.network.node[i-1]["element"].grid_position >
                            ...
                            self.secondary_length - self.floorslab_grids[0][1][current_layer_counter] < self.primary_outside_support_distance_to_edge_max
                            ):
...
advanced_floorslab_setup(Slabassembly, 30.0, 30)
