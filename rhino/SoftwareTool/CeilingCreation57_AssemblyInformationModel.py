...
class Floorslabsystem:
    ...
    # weight calculation
    def weight_calculator(self, protective_clay_height = 5.0, density_timber = 460, density_clay = 1700, fill_limit = None):
    ...
    def board_geometry_setup(self):
        for my_layer in range(self.layer_no):
            ...
            for my_board in self.timberboards[my_layer]:
                ...
                # one advanced case
                layer_standard_length = self.timberboards[my_layer][0].length
...
myFloorslab.vert_sup_setup(False, False)
myFloorslab.floorslab_creation()
myFloorslab.weight_calculator(5.0, 460, 1900, 2)

# bei den Instances Exports muss man noch aufpassen wegen den kurzen stücken?
print(myFloorslab.component_instances_export())

#bigAssembly = myFloorslab.transfer_to_assembly()
