...
class Ceilingsystem:
    ...
    def input_check(self):
        ...
        if self.primary_dedensification == 0:
            ...
            no_intervals = (self.primary_length-self.primary_board_width_outside) // self.primary_interval
            if interval_intolerance > 0.0:
                self.primary_interval += interval_intolerance
            print("interval adjusted")
